...
# CaltechClimate_Nov2020 <- CaltechClimate_Nov2020 %>% mutate(Abortion = as.factor(Abortion %in% c("Very important","Somewhat important")))
...
save(margin.reduced,regression_2020,regression_2022,file="Data/counterfactual.RData")
